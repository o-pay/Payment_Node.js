...
let exp = 'PLEASE MODIFY';  // 付款期限，ex: 2017/02/13 15:45:30

let create = new opay_payment();
let htm = create.payment_client.aio_check_out_tenpay(parameters = base_param, invoice = inv_params, expire_dt = exp);
console.log(htm);