...
let base_param = {
    MerchantTradeNo: 'dfdsfrgrgtfhfhg', //請帶20碼uid, ex: f0a0d7e9fae1bb72bc93
...
let htm = create.payment_client.aio_check_out_weixinpay(parameters = base_param, invoice = inv_params);
console.log(htm);