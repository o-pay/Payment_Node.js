...
let base_param = {
    MerchantTradeNo: '313151561356', //請帶20碼uid, ex: f0a0d7e9fae1bb72bc93
...
let htm = create.payment_client.aio_check_out_credit_divide(parameters = base_param, invoice = inv_params, installment = inst);
console.log(htm);